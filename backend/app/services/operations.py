...
class OperationsService:
    ...
    async def mobile_sync_package(self, organization_id: UUID) -> MobileSyncPackageRead:
        ...
        return MobileSyncPackageRead(
            ...
            frequency_rules=[
                {"code": "once_ever", "label": "one submission, ever"},
                {"code": "once_per_project", "label": "one submission per project"},
                {"code": "once_per_year", "label": "one submission per year"},
                {"code": "once_per_season", "label": "one submission per season"},
                {"code": "once_per_quarter", "label": "one submission per quarter"},
                {"code": "once_per_month", "label": "one submission per month"},
                {"code": "once_per_event", "label": "one submission per event"},
                {"code": "unlimited", "label": "no submission limit"},
            ],
