...
- Inline field selection with a properties rail for labels, types, required rules, and future validation editing.
- Logic editor surface for visibility, required-if, validation, and calculated expressions.
- Mobile schema preview that exports offline-compatible sections, fields, options, validation, and logic metadata.
