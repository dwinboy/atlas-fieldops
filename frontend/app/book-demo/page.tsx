...
export const metadata: Metadata = marketingMetadata({
  title: "Book a Demo",
  description: "Book a demo of Atlas FieldOps for offline data collection, mobile forms, inspections, inventory checks, GIS mapping, KPI tracking, data quality, and governed reporting.",
  path: "/book-demo",
});
    ...
    <MarketingShell>
      <main>
        <SimplePageHero
          ...
          text="Share your organization, country, field team size, and sector. We will help map Atlas FieldOps to your data collection, mobile operations, GIS, KPI, and reporting workflows."
        />
        <section className="mx-auto grid max-w-6xl gap-8 px-4 pb-20 sm:px-6 lg:grid-cols-[1fr_0.8fr] lg:px-8">
          ...
          <aside className="rounded-2xl border border-black/10 bg-[#0c1f1b] p-6 text-white">
            ...
            <ul className="mt-5 space-y-3 text-sm leading-6 text-white/72">
              <li>• Project, sector pack, and form creation flow</li>
              <li>• Offline mobile data collection and sync</li>
              <li>• Review, approval, and data quality controls</li>
              <li>• GIS mapping, KPIs, client reports, and donor reports</li>
