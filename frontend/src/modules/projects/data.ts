...
export const previewProjects: ProjectListItemRead[] = [
  ...
  },
  {
    ...
    id: "project-edu",
    indicator_count: 4,
    name: "Education Attendance Baseline",
    owner: "M&E Manager",
    progress_percent: 25,
...
export const previewDetail: ProjectDetailRead = {
  ...
  reports: [
    { category: "report", id: "report-1", label: "Quarterly Donor Update", metric: "Ready for review", status: "draft", updated_at: new Date().toISOString() },
  ],
  submissions: [
...
export const previewTemplates: ProjectTemplateRead[] = [
  {
    description: "Baseline project with household forms, enumerator teams, indicator baselines, and governance setup.",
    forms: 2,
    governance_controls: 5,
    id: "baseline-survey",
    indicators: 8,
    name: "Baseline Survey Project",
    status: "published",
    template_type: "Baseline Survey",
  },
  {
    description: "Recurring monitoring project with assignments, quality checks, indicators, and scheduled reporting.",
    forms: 3,
    ...
    status: "published",
    template_type: "Monitoring Program",
  },
  {
    description: "Evaluation project for midline, endline, comparisons, reporting, and auditability.",
    forms: 4,
