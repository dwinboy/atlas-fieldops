...
import { BarChart3, Boxes, Building2, ClipboardList, Database, Files, Fingerprint, GitPullRequestArrow, LayoutDashboard, Map, Search, ShieldCheck, UsersRound, Wifi } from "lucide-react";
