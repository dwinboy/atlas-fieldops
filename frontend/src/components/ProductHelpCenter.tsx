...
const helpTopics: HelpTopic[] = [
  ...
  },
  {
    ...
    purpose:
      "Submission review protects data quality before information enters reports, dashboards, maps, and program records.",
    audience: "Supervisors, data quality teams, and approvers",
    view: "submissions",
    icon: ShieldCheck,
    whenToUse:
      "Use Review queue after field officers sync submissions, when validation flags appear, or before reporting data to leadership or donors.",
    beforeYouStart: [
  ...
  },
  {
    ...
    icon: Map,
    whenToUse:
      "Use Map during coverage planning, field validation, route review, facility monitoring, farm boundary review, or location-based reporting.",
    beforeYouStart: [
  ...
  },
  {
    ...
    purpose:
      "Indicators and reports convert approved field data into progress tracking, operational summaries, logframes, donor outputs, and leadership dashboards.",
    audience: "M&E managers, analysts, and leadership teams",
    view: "analytics",
    icon: BarChart3,
    whenToUse:
      "Use Indicators and Reports during program reviews, donor reporting, management meetings, and performance analysis.",
    beforeYouStart: [
    ...
    result:
      "Decision makers receive current, traceable information from approved field data.",
    nextActions: [
