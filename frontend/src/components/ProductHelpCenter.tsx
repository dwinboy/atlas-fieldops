...
const helpTopics: HelpTopic[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      "Open the existing record when a match exists. New beneficiaries should normally come from a project import or an approved project-linked registration form.",
      ...
      "Use approved submissions to create or update official beneficiary records according to the form entity mapping and project rules.",
      "Use the beneficiary record when reviewing submissions, cases, interventions, reports, and longitudinal progress.",
    ],
    dataLanguage: [
      "Beneficiary name",
      "Household",
    ...
    goodPractice: [
      ...
      "Use the beneficiary code as the stable public identifier and keep legacy IDs separately.",
    ...
    avoid: [
      ...
      "Do not create beneficiaries from draft, returned, rejected, or unapproved submissions unless a governance rule explicitly allows it.",
