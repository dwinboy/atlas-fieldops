    ...
    items: [
      {
        ...
        hint: "GIS & coverage",
        description:
          "GIS mapping, geographic analysis, coverage monitoring, and spatial validation.",
        route: "/mapping",
        domain: "ANALYTICS",
        icon: MapPinned,
        tone: "monitor",
      ...
      },
      {
        ...
        description:
          "Generate standard reports, custom reports, dashboards, scheduled reports, and exports.",
        route: "/reports",
        domain: "ANALYTICS",
        ...
        children: [
          ...
          { label: "Exports", route: "/reports/exports", description: "Authorized data exports." },
        ],
      },
      {
        id: "dataQuality",
...
const legacyItems: NavigationItem[] = [
  ...
  },
  {
    ...
    description:
      "Beneficiary records used by projects and field operations.",
    route: "/projects/all",
    domain: "OPERATIONS",
    icon: HeartHandshake,
    tone: "collect",
    ...
    hiddenFromSidebar: true,
    keywords: ["beneficiary", "household", "farmer"],
  },
  {
    id: "data",
    label: "Data Tools",
